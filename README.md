# Koe no Ki (声の木) - Visual Seiyuu Tree
...
- [ani-client](https://ani-client.js.org) - A powerful AniList API wrapper by [gonzyui](https://gonzyuidev.xyz).
- [Vue Flow](https://vueflow.dev/) - Highly customizable library for building node-based applications.
- [Lucide](https://lucide.dev/) - Beautiful & consistent icons.
- [html-to-image](https://github.com/bubkoo/html-to-image) - Capture DOM nodes as images.
